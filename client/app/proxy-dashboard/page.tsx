    ...
    <div className="min-h-screen bg-background text-foreground flex">
      <aside className="h-screen w-64 fixed left-0 top-0 bg-background dark:bg-background flex flex-col h-full py-lg px-md z-50">
        <div className="flex items-center gap-md mb-xl">
          ...
          <div>
            <h1 className="text-2xl font-semibold text-primary dark:text-primary leading-tight">
              ProxyFlow
            </h1>
        ...
        <nav className="flex-1 space-y-xs overflow-y-auto custom-scrollbar">
          <a
            className="flex items-center gap-md px-md py-sm rounded-lg text-primary dark:text-primary font-bold border-r-4 border-primary bg-accent transition-colors"
            href="#"
          >
        ...
        <header className="fixed top-0 right-0 w-[calc(100%-16rem)] z-40 bg-background dark:bg-background bg-background dark:bg-background shadow-sm flex justify-between items-center px-lg h-16">
          <div className="flex items-center gap-md">
            <div className="relative group">
              ...
              <input
                className="bg-card border-none rounded-full pl-10 pr-lg py-xs text-sm focus:ring-2 focus:ring-primary w-64 transition-all"
          ...
          <div className="flex items-center gap-lg">
            <div className="flex items-center gap-sm px-md py-xs bg-secondary rounded-full border border-border">
              ...
              <span className="font-medium uppercase tracking-wider text-xs text-foreground">
                Balance: 45.2 GB
              </span>
            </div>
            ...
            <div className="flex items-center gap-sm border-l border-border pl-lg">
              <div className="text-right hidden xl:block">
                <p className="font-medium uppercase tracking-wider text-xs text-foreground">
                  Alex Rivera
                </p>
              ...
              <img
                ...
                data-alt="A professional headshot of a Hispanic male software engineer in his late 20s, wearing a minimalist black turtleneck, against a warm earthy brown studio background. The lighting is dramatic with soft amber key light highlighting his face. High-end professional photography style, sharp focus, 8k resolution, maintaining the amber and earth aesthetic of the ProxyFlow brand."
                src="https://lh3.googleusercontent.com/aida-public/AB6AXuAibitkabF_S7lazLBupeQ6BRar1Jjf5go0DHkQd9RQG5c20n8fk2udidG1RgbDjI8rXdFsbZrWHW9sJOpLebedc_eXM7oGGmi5EUKxOijgR71T2QVEt_muvuL7ynmADcnwyJCOXJp8Ud4QQ9k2c1izsJ6aKAUdKmdZG6fK9_gFCDzUHtt9JArcM2OKoOD2nWoHxE6CujyGRmVbX68M5agrgWQ1BaeTNr-itfZCm6Nz7nFFg5N0et0FN7asfUoW7XiET6Mz8XrMXEU"
              />
            </div>
          </div>
        </header>
            ...
            <div className="bg-card p-lg rounded-xl border border-border flex flex-col justify-between">
              <div className="flex justify-between items-start mb-md">
                ...
                <div className="p-xs bg-blue-500/20 rounded-lg">
                  <span className="material-symbols-outlined text-blue-500 text-md">
                    hub
                  </span>
                </div>
              </div>
            ...
            <div className="bg-card p-lg rounded-xl border border-border flex flex-col justify-between">
              <div className="flex justify-between items-start mb-md">
                ...
                <div className="p-xs bg-purple-500/20 rounded-lg">
                  <span className="material-symbols-outlined text-purple-500 text-md">
                    bolt
                  </span>
                </div>
              </div>
            ...
            <div className="bg-card p-lg rounded-xl border border-border flex flex-col justify-between">
              <div className="flex justify-between items-start mb-md">
                ...
                <div className="p-xs bg-emerald-500/10 rounded-lg">
                  <span className="material-symbols-outlined text-emerald-400 text-md">
                    verified
                  </span>
                </div>
              </div>
          ...
          <section className="grid grid-cols-1 lg:grid-cols-3 gap-lg h-[400px]">
            <div className="lg:col-span-2 bg-card p-lg rounded-xl border border-border relative overflow-hidden flex flex-col">
              <div className="flex justify-between items-center mb-xl">
                <div>
                  ...
                  <p className="text-xs text-muted-foreground">
                    Consumption trends over the last 24 hours
                  </p>
                </div>
                <div className="flex gap-sm">
                  <button className="px-md py-xs bg-secondary rounded text-xs text-foreground border border-border">
                    24H
                  </button>
                  <button className="px-md py-xs bg-background rounded text-xs text-muted-foreground hover:bg-secondary transition-colors">
                    7D
                  </button>
                </div>
              </div>
              <div className="flex-1 relative">
                ...
                >
                  <path
                    d="M0,320 Q125,280 250,200 T500,100 T750,150 T1000,50"
                    fill="none"
                    stroke="#ffb968"
                    strokeLinecap="round"
                    strokeWidth="4"
                  ...
                  <circle
                    ...
                    r="6"
                  />
                  <circle cx="500" cy="100" fill="#ffb968" r="4" />
                </svg>
              </div>
            </div>

            <div className="bg-card p-lg rounded-xl border border-border flex flex-col">
              <h3 className="text-base font-semibold text-foreground mb-lg">
                Top Regions
              </h3>
          ...
          <section className="bg-card rounded-xl border border-border overflow-hidden">
              ...
              <table className="w-full text-left border-collapse">
                <thead>
                  <tr className="bg-secondary">
                    <th className="px-lg py-md font-medium uppercase tracking-wider text-xs text-muted-foreground uppercase tracking-wider">
                      IP Address
                    </th>
                    <th className="px-lg py-md font-medium uppercase tracking-wider text-xs text-muted-foreground uppercase tracking-wider">
                      Type
                    ...
                    <th className="px-lg py-md font-medium uppercase tracking-wider text-xs text-muted-foreground uppercase tracking-wider text-right">
                      Actions
                    </th>
                  </tr>
                </thead>
                <tbody className="divide-y divide-outline-variant">
                  <tr className="hover:bg-accent transition-colors">
                    <td className="px-lg py-md">
                      <div className="flex items-center gap-sm">
                        ...
                        <span className="material-symbols-outlined text-xs text-muted-foreground cursor-pointer hover:text-primary">
                          content_copy
                        </span>
                      </div>
                    </td>
                    <td className="px-lg py-md">
                      <span className="px-sm py-xs bg-background text-purple-500 text-xs rounded border border-secondary/20">
                        Residential
                      </span>
                    </td>
                    <td className="px-lg py-md">
                    ...
                    <td className="px-lg py-md text-emerald-400 font-bold">
                      24ms
                    </td>
                    <td className="px-lg py-md">
                    ...
                    <td className="px-lg py-md text-right">
                      <button className="material-symbols-outlined text-muted-foreground hover:text-primary transition-all">
                        more_vert
                      </button>
                    </td>
                  </tr>
                  ...
                  <tr className="hover:bg-accent transition-colors">
                    ...
                    <td className="px-lg py-md">
                      <span className="px-sm py-xs bg-background text-blue-500 text-xs rounded border border-tertiary/20">
                        ISP
                      </span>
                    </td>
                    <td className="px-lg py-md">
            ...
            <div className="px-lg py-md border-t border-border flex justify-between items-center bg-secondary/50">
              <span className="text-xs text-muted-foreground">
                Showing 3 of 854 active proxies
              </span>
              <div className="flex items-center gap-md">
                <button
                ...
                <button className="px-md py-xs bg-primary text-primary-foreground rounded text-xs font-bold shadow-md">
                  Next
                </button>
              </div>
            </div>
      ...
      <div className="fixed bottom-4 right-4 z-50 flex gap-2">
        ...
        <Link
          href="/dashboard"
          className="flex items-center gap-2 bg-primary text-primary-foreground px-4 py-2 rounded-full shadow-lg hover:opacity-90"
        >
